    ...
    <section ref={ref}>
      ...
      >
       ...
       <img style={{
        ...
        className="z-10 w-full mt-28" src="https://res.cloudinary.com/daknbj7xw/image/upload/v1666090903/Mari/BR_dwvweq.png" alt="" />
        </div>
        ...
        className="mb-5 text-3xl font-bold">Learn Portuguese with Mariana</h1>
            <p className="mb-5">
